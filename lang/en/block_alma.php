<?php
/**
 * Strings for component 'block_alma', language 'en'
 *
 * @package   block_alma
...
$string['overdueitem'] = 'You have {$a} overdue item';
$string['overdueitems'] = 'You have {$a} overdue items';
$string['fines'] = 'You owe &pound;{$a} in fines';
